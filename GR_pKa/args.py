...
class CommonArgs(Tap):
    ...
    """Path to generated adjacency matrices to use in Atom retention block."""
    distance_path: str = None
    """Path to generated distance matrices to use in Atom retention block."""
    coulomb_path: str = None
    """Path to generated coulomb matrices to use in Atom retention block."""
...
class TrainArgs(CommonArgs):
    ...
    f_scale: int = 0.45
    """The scale of matrices added the retention weight"""
    adjacency: bool = False
    """Whether to add adjacency feature matrix to the retention weight"""
    distance: bool = False
    """Whether to add distance matrix to the retention weight"""
    coulomb: bool = False
    """Whether to add coulomb matrix to the retention weight"""
