...
class MoleculeModel(nn.Module):
    ...
    def forward(self,
        ...
        # b = self.encoder_b(batch, features_batch, mol_adj_batch,
        #                                mol_dist_batch, mol_clb_batch)
        # a = self.encoder_a(batch, features_batch, mol_adj_batch,
        #                                mol_dist_batch, mol_clb_batch)
        # output = self.ffn(0.5*a + 0.5*b)
        output = self.encoder(batch, features_batch, mol_adj_batch,
                                        mol_dist_batch, mol_clb_batch)
